...
// Table and Kanban are implemented; Calendar/Timeline/Gantt stay visible-but-disabled until
// their phases land — the view system is designed so new views can be added without reworking
// this component or the page around it, per the project's view architecture.
