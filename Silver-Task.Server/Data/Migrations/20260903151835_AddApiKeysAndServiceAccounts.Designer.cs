...
namespace Silver_Task.Server.Data.Migrations
{
    ...
    [Migration("20260903151835_AddApiKeysAndServiceAccounts")]
    partial class AddApiKeysAndServiceAccounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Silver_Task.Server.Models.Entities.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Silver_Task.Server.Models.Entities.EmailDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Silver_Task.Server.Models.Entities.EmailTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("HeadingTemplate")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("Silver_Task.Server.Models.Entities.TaskNotificationMute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TaskNotificationMutes", (string)null);
                });
            ...
            modelBuilder.Entity("Silver_Task.Server.Models.Entities.UserNotificationSetting", b =>
                {
                    ...
                    b.Property<string>("EmailDeliveryMode")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
            ...
            modelBuilder.Entity("Silver_Task.Server.Models.Entities.UserPreference", b =>
                {
                    ...
                    b.Property<DateTime?>("LastDailyDigestAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("WeeklyDigestDay")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("Silver_Task.Server.Models.Entities.ApiKey", b =>
                {
                    ...
                    b.HasOne("Silver_Task.Server.Models.Entities.User", "RevokedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Silver_Task.Server.Models.Entities.EmailDelivery", b =>
                {
                    ...
                    b.HasOne("Silver_Task.Server.Models.Entities.Notification", "Notification")
                        .WithMany()
                        .HasForeignKey("NotificationId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Silver_Task.Server.Models.Entities.User", "RecipientUser")
                        .WithMany()
